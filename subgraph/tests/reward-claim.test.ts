import { assert, beforeAll, describe, test, clearStore } from "matchstick-as/assembly/index"
...
describe("RewardClaim mapping tests", () => {
  beforeAll(() => {
    ...
    let winner = Address.fromString("0x0000000000000000000000000000000000000001")
